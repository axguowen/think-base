...
class Response extends Base
{
     ...
     * @var string
     */
    protected static $codeField = 'code';

    /**
     * 错误信息字段名
     * @var string
     */
    protected static $messageField = 'message';
    ...
    public static function failed($message = null, $code = null, $data = [], $type = 'json')
    {
        ...
        if(is_null($message)){
            // 获取错误码对应的错误信息
            $message = isset(static::$errorMessage[$code]) ? static::$errorMessage[$code] : '未知错误';
        }
        // 如果类型是数组
        if($type == 'array'){
            // 返回数组
